...
import {dashboardContext} from '../Components/ContextComponent/DashboardContextComponent';
...
<div className="container-fluid">
    ...
    {/* <!-- Content Row --> */}
    <div className="row">
    <Card label="Earnings (Monthly)" value={data.earningMonthly} border="primary" icon="fas fa-calendar fa-2x text-gray-300"/>
    <Card label="Earnings (Annual)" value={data.earningAnnual} border="success" icon="fas fa-dollar-sign fa-2x text-gray-300"/>
    <ProgressiveCard label="Tasks" value={data.tasks} border="info" icon="fas fa-clipboard-list fa-2x text-gray-300"/>
    <Card label="Pending Requests" value={data.pendingRequest} border="warning" icon="fas fa-comments fa-2x text-gray-300"/>
    </div>
            ...
            return <tr key={i}>
                ...
                <td>
                    <Button variant="primary" onClick={()=> navigate(`/editUser/${i}`)}>
                        ...
                        &nbsp;
                        &nbsp;
                    <Button variant="danger" onClick={()=>{userDelete(i)}}>
